  ...
  return (
    <section className='intro'>
      <div className="intro-container">
        ...
        <p className='intro-preface'>Hi, I'm David Bilson. I am a Fullstack Software Developer, my specialization revolves around developing intuitive and user-friendly websites that enable businesses and individuals to effectively accomplish their objectives.</p>
